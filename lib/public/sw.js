...
self.addEventListener("push", function (event) {
  ...
  event.waitUntil(
    self.clients.matchAll({ type: "window", includeUncontrolled: true }).then(function (clientList) {
      // Always show permission requests, questions, errors, and done notifications
      if (data.type !== "permission_request" && data.type !== "ask_user" && data.type !== "error" && data.type !== "done") {
